...
| 任务 | 状态 | 完成日期 | 备注 |
|------|------|----------|------|
| 1.1 创建目录结构和基类 | ✅ 完成 | 2026-06-09 | src/ui/settings/tabs/, widgets/ |
| 1.2 提取 GeneralTab | ✅ 完成 | 2026-06-09 | 语言、主题、权限、启动 |
| 1.3 提取 CaptureTab | ✅ 完成 | 2026-06-09 | 自动保存、截图行为 |
| 1.4 提取 SaveTab | ✅ 完成 | 2026-06-09 | 合并到 CaptureTab |
| 1.5 提取 AnnotationTab | ✅ 完成 | 2026-06-09 | 颜色、线宽、字体 |
| 1.6 提取 OcrTab | ✅ 完成 | 2026-06-09 | OCR 语言、引擎测试 |
| 1.7 提取 ShortcutsTab | ✅ 完成 | 2026-06-09 | 全局/编辑器快捷键 |
| 1.8 提取 AdvancedTab | ✅ 完成 | 2026-06-09 | Pin 窗口、日志 |
| 1.9 重构主对话框 | ✅ 完成 | 2026-06-09 | dialog.py 使用 Tab 模块 |
| 1.10 迁移搜索和导入导出 | ✅ 完成 | 2026-06-09 | 集成在 dialog.py |
