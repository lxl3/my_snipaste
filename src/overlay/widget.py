...
class CaptureOverlay(QWidget, OverlayEventHandlerMixin, OcrMixin, OverlayRenderingMixin, OverlayActionsMixin, OverlayTransformsMixin, OverlaySelectionMixin, OverlayDrawingMixin):
